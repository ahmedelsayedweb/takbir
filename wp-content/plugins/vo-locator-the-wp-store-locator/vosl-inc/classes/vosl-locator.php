...
class VoStoreLocator {
	...
	public function add_admin_menu() {
		...
		add_submenu_page( VOSL_PAGES_DIR.'/locations.php', __("Listings", VOSL_TEXT_DOMAIN), __("Manage Listings", VOSL_TEXT_DOMAIN), $vosl_capability, VOSL_PAGES_DIR.'/locations.php', '');
		...
		add_submenu_page(VOSL_PAGES_DIR.'/locations.php', __("Manage Tags", VOSL_TEXT_DOMAIN), __("Manage Tags", VOSL_TEXT_DOMAIN), $vosl_capability, VOSL_PAGES_DIR.'/manage-tags.php', '');
